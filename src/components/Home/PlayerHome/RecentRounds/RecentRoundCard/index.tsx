import { Card, XStack, YStack, Text, View, Image } from "tamagui";
...
export function RecentRoundCard({ roundData }: RoundCardProps) {
          ...
          {roundData.scores
            ...
            .map((score, index) => (
              <XStack key={index} gap={48} style={{ alignItems: "center" }}>
                <PlayerAvatar
                  name={score.league_name}
                  avatarUrl={roundData.league_img}
                  size="$4"
                  color={score.league_color}
                />
